...
![Jenkins Pipeline](https://raw.githubusercontent.com/ndevops25/jenkins-cicd-aws/main/docs/images/pipeline-running.png)
...
![Configuração do Token no SonarQube](https://raw.githubusercontent.com/ndevops25/jenkins-cicd-aws/main/docs/images/sonarqube-token.png)
...
![Configuração do SonarQube Scanner](https://raw.githubusercontent.com/ndevops25/jenkins-cicd-aws/main/docs/images/sonarqube-jenkins-config.png)
...
![Configuração do SonarQube Scanner Plugin](https://raw.githubusercontent.com/ndevops25/jenkins-cicd-aws/main/docs/images/sonarqube-scanner-plugin.png)

- Configuração do SonarQube Scanner com o plugin instalado na plataforma Jenkins:
![Configuração do SonarQube Scanner Config](https://raw.githubusercontent.com/ndevops25/jenkins-cicd-aws/main/docs/images/sonarqube-scanner-config.png)
...
![Jenkins Pipeline in platform](https://raw.githubusercontent.com/ndevops25/jenkins-cicd-aws/main/docs/images/pipeline-running.png)

- Pipeline executado:
![Jenkins Pipeline Executed with SonarQube](https://raw.githubusercontent.com/ndevops25/jenkins-cicd-aws/main/docs/images/jenkins-pipeline-with-sonarqube.png)
...
![SonarQube Dashboard](https://raw.githubusercontent.com/ndevops25/jenkins-cicd-aws/main/docs/images/sonarqube-dashboard.png)

- Pressione a linha de informações para ver os detalhes da inspeção de qualidade:
![SonarQube Details Dashboard](https://raw.githubusercontent.com/ndevops25/jenkins-cicd-aws/main/docs/images/sonarqube-dashboard-details.png)
